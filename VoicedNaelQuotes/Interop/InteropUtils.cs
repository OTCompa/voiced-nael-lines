...
public static unsafe class InteropUtils
{
    ...
    //public static void PrepPap(nint resource, List<string> ids, List<short> types ) {
    //    if( ids == null || types == null ) return;
    //    Marshal.WriteByte( resource + Constants.PrepPapOffset, Constants.PrepPapValue );
    //}

    //public static void WritePapIds(nint resource, List<string> ids, List<short> types ) {
    //    if( ids == null ) return;
