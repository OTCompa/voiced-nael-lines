...
public unsafe class ActorVfx : BaseVfx
{
    ...
    {
        if (Vfx != null) { return; }
        Vfx = (ActorVfxStruct*)hooks.ActorVfxCreate(Path, casterAddress, targetAddress, -1, (char)0, 0, (char)0);
    }

    public override nint GetVfxPointer()
    {
        return (nint)Vfx;
    }
    ...
    {
        if (Vfx == null) { return; }
        hooks.ActorVfxRemove((nint)Vfx, (char)1);
        Vfx = null;
    }
